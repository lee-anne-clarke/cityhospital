...
$("a.cal-linksets").on('click', function(){
    var $this = $(this);
    var target = $this.data('content');
    $('a.cal-linksets').not($this).each(function(){
       var $other = $(this);
       var otherTarget = $other.data('content');
       $(otherTarget).hide();        
    });
    $(target).animate({width: "toggle"}, 10);    
});


$('a.cal-linksets').click(function(){
	$('a.cal-linksets').removeClass('active-link');
...
// SharePoint Share box

$("a.sharetab").on('click', function(){
    var $this = $(this);
    var target = $this.data('content');
    $('a.sharetab').not($this).each(function(){
       var $other = $(this);
       var otherTarget = $other.data('content');
       $(otherTarget).hide();        
    });
...
$('a.sharetab').click(function(){
	$('a.sharetab').removeClass('sharetab-active');
	$(this).toggleClass('sharetab-active');
});
...
$("a.whatsnew-linksets").on('click', function(){
    var $this = $(this);
    var target = $this.data('content');
    $('a.whatsnew-linksets').not($this).each(function(){
       var $other = $(this);
       var otherTarget = $other.data('content');
       $(otherTarget).hide();        
    });
...
$('a.whatsnew-linksets').click(function(){
	$('a.whatsnew-linksets').removeClass('active-link');
	$(this).toggleClass('active-link');
});
